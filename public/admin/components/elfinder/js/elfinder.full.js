		...
		if (this.options.dialog || this.options.docked) {
			...
			if (this.options.docked) {
				...
				this.options.dialog.close = function() { 
                                    if (input) {
                                        var eid;
                                        if (input.indexOf("event_edit_video640_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_video640";
                                        } else if (input.indexOf("event_edit_video720_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_video720";
                                        } else if (input.indexOf("event_edit_video480_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_video480";
                                        } else if (input.indexOf("event_edit_video320_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_video320";
                                        } else if (input.indexOf("event_edit_image640_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_image640";
                                        } else if (input.indexOf("event_edit_image720_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_image720";
                                        } else if (input.indexOf("event_edit_image480_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_image480";
                                        } else if (input.indexOf("event_edit_image320_") == 0) {
                                            eid = input.substr(20);
                                            input = "event_edit_image320";
                                        } else if (input.indexOf("event_edit_teaser640_") == 0) {
                                            eid = input.substr(21);
                                            input = "event_edit_teaser640";
                                        } else if (input.indexOf("event_edit_teaser720_") == 0) {
                                            eid = input.substr(21);
                                            input = "event_edit_teaser720";
                                        } else if (input.indexOf("event_edit_teaser480_") == 0) {
                                            eid = input.substr(21);
                                            input = "event_edit_teaser480";
                                        } else if (input.indexOf("event_edit_teaser320_") == 0) {
                                            eid = input.substr(21);
                                            input = "event_edit_teaser320";
                                        } 
                                        ...
                                        switch (input) {
                                            ...
                                            case 'image320':
                                                getEventTeasers(320);
                                                break;
                                            case 'event_edit_image640':
                                                getEventImages(eid, 640);
                                                break;
                                            case 'event_edit_image720':
                                                getEventImages(eid, 720);
                                                break;
                                            case 'event_edit_image480':
                                                getEventImages(eid, 480);
                                                break;
                                            case 'event_edit_image320':
                                                getEventImages(eid, 320);
                                                break;
                                             case 'event_edit_video640':
                                                getEventVideos(eid, 640);
                                                break;
                                            case 'event_edit_video720':
                                                getEventVideos(eid, 720);
                                                break;
                                            case 'event_edit_video480':
                                                getEventVideos(eid, 480);
                                                break;
                                            case 'event_edit_video320':
                                                getEventVideos(eid, 320);
                                                break;
                                            case 'event_edit_teaser640':
                                                getEventVideoTeasers(eid, 640);
                                                break;
                                            case 'event_edit_teaser720':
                                                getEventVideoTeasers(eid, 720);
                                                break;
                                            case 'event_edit_teaser480':
                                                getEventVideoTeasers(eid, 480);
                                                break;
                                            case 'event_edit_teaser320':
                                                getEventVideoTeasers(eid, 320);
                                                break;
                                               
                                            case 'event_add_image480':
                                                getEventImagesFromTempDir(480);
                                                break;
                                            case 'event_add_image320':
                                                getEventImagesFromTempDir(320);
                                                break;
                                            case 'event_add_image720':
                                                getEventImagesFromTempDir(720);
                                                break;
                                            case 'event_add_image640':
                                                getEventImagesFromTempDir(640);
                                                break;
                                                
                                            
                                            case 'event_add_teaser480':
                                                getEventVideoTeasersFromTempDir(480);
                                                break;
                                            case 'event_add_teaser320':
                                                getEventVideoTeasersFromTempDir(320);
                                                break;
                                            case 'event_add_teaser720':
                                                getEventVideoTeasersFromTempDir(720);
                                                break;
                                            case 'event_add_teaser640':
                                                getEventVideoTeasersFromTempDir(640);
                                                break;
