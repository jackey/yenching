...
$root = '../../../../../uploads/temp/' . $aid . '/events/320/';
$url = '/medias/uploads/temp/' . $aid . '/events/320/';

if (isset($_SESSION['events']) && isset($_SESSION['events']['action']) && $_SESSION['events']['action'] == 'add') {
    $root = '../../../../../uploads/temp/' . $aid . '/teasers/320/';
    $url = '/medias/uploads/temp/' . $aid . '/teasers/320/';
} else 
if (isset($_SESSION['events']) && isset($_SESSION['events']['eid']) && isset($_SESSION['events']['action'])) {
    if ($_SESSION['events']['action'] == 'edit') {
        ...
        $root = '../../../../../uploads/events/' . $eid . '/teasers/320/';
        $url = '/medias/uploads/events/' . $eid . '/teasers/320/';
    }
}
...
$opts = array(
	...
	'URL'             => $url, //'/medias/uploads/temp/' . $aid . '/events/320/', // root directory URL
