...
//      goToByScroll($("#program .slider"));
    ...
    $(".body .right-bar .m-item-1").click(function() {
...
//        searchInput.css({
//            top: top,
//            left: (position["left"]) - ($(searchInput).width()),
//        }).show().focus();
...
// Search result go to the item section 
(function($) {
  $(function() {
...
(function($) {
  $(function() {
    $(".body .right-bar .m-item-0, #program .apply-btn").click(function() {
      $("#applypopdiv").removeClass("hideme");
      $("body > .loading").removeClass("hideme");
      $("body > .loading img").addClass("hideme");
    });
  });
