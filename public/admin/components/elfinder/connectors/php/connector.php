...
define('MEDIA_PATH', realpath(APPLICATION_PATH . '/../medias/'));

define('RESOURCES_LANGUAGES', realpath('/Applications/MAMP/htdocs/ZendFramework-1.12.3/resources/languages'));

require_once 'Zend/Application.php';
$application = new Zend_Application(APP_ENV, APPLICATION_PATH . '/configs/application.ini');
...
//$root = "../../../../../uploads/events/";
$root = APPLICATION_PATH.'/../medias';

$opts = array(
	'root'            => $root,           // path to root directory
	'URL'             => '/medias/', // root directory URL
