...
$root = '../../../../../uploads/temp/' . $aid . '/events/480/';
$url = '/medias/uploads/temp/' . $aid . '/events/480/';

if (isset($_SESSION['events']) && isset($_SESSION['events']['action']) && $_SESSION['events']['action'] == 'add') {
    $root = '../../../../../uploads/temp/' . $aid . '/teasers/480/';
    $url = '/medias/uploads/temp/' . $aid . '/teasers/480/';
} else 
if (isset($_SESSION['events']) && isset($_SESSION['events']['eid']) && isset($_SESSION['events']['action'])) {
    if ($_SESSION['events']['action'] == 'edit') {
        ...
        $root = '../../../../../uploads/events/' . $eid . '/teasers/480/';
        $url = '/medias/uploads/events/' . $eid . '/teasers/480/';
    }
}
...
$opts = array(
	...
	//'URL'             => '/medias/uploads/events/', // root directory URL
        'URL'             => $url, //'/medias/uploads/temp/' . $aid . '/events/480/', // root directory URL
